...
//弹出loading
    ...
    $.ajax({
        url : getRootPath('/res/ajax_res_menu_top.do'),
        type : 'post',
        async: false,
    ...
    function leftNavBar(pid) {
        $.ajax({
            url : getRootPath('/res/ajax_res_menu_left.do'),
            type : 'post',
            async: false,
            data:{
                resParentid:pid
                        ...
                        $.each(pdata,function(index,item){
                            ...
                            if(item.children != null ){
                                ...
                                $.each(item.children,function(index,child){
                                    ulHtml += '<dd><a href="javascript:;" data-url="'+getRootPath(child.href)+'">';
                                    if(child.icon != null){
                                ...
                                ulHtml += '<a href="javascript:;" data-url="'+getRootPath(item.href)+'">';
                                ulHtml += '<i class="layui-icon larry-icon '+item.icon+'" data-icon="'+item.icon+'"></i>';
                                ulHtml += '<cite>'+item.title+'</cite></a>';
                            }
                            ulHtml += '</li>'
