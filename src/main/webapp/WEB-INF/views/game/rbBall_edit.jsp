...
<form class="layui-form layui-form-pane">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input" name="issue" lay-verify="required|issue" maxlength="20" value="${rbBallInfo.issue}" placeholder="请输入1-480 期数">
        </div>
    </div>
    <div class="layui-form-item">
...
<script type="text/javascript">
    layui.config({
        ...
        form.verify({
            ...
            issue: function(value, item){
                //验证用户名
              if(value==null||value > 480){
                    return '不能为空';
                }
              if(value > 480){
                  return '不能大于480';
            ...
            lotteryResult: function(value, item){
                //验证用户名
                if(value==null){
                    return '不能为空';
                }
        ...
        form.on("submit(saveUser)",function(data){
            ...
            //登陆验证
            $.ajax({
                url : '${ctx}/gameActive/ajax_add_rbBall.do',
                type : 'post',
                async: false,
                data : data.field,
