					...
					<div class="layui-inline">
						<form class="layui-form" id="orderSearchForm">
							<div class="layui-input-inline">
								<label for="begin">开始时间:</label><input name="beginStr"
									id="beginStr" type="date" />
							</div>
							<div class="layui-input-inline">
								<label for="end">结束时间:</label><input name="endStr" id="endStr"
									type="date" />
							</div>
							...
							<input hidden="true"type="text" name="searchTerm1" value="orderTypeTerm">
							<div class="layui-input-inline" style="width: 110px;">
								<select name="searchContent1">
