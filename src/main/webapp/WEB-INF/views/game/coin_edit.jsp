...
<body class="childrenBody" style="font-size: 12px; margin: 10px 10px 0;">
	<form class="layui-form layui-form-pane">
		...
		<div class="layui-form-item">
			<label class="layui-form-label">新增金币数量</label>
			<div class="layui-input-block">
				<input type="text" class="layui-input" name="coin" maxlength="20"
					value="" placeholder="请输入新增金币数量">
			</div>
		</div>
		<div class="layui-form-item">
		...
		<div class="layui-form-item">
			<label class="layui-form-label">金币备注</label>
			<div class="layui-input-block">
				<input type="text" class="layui-input" name="desc" maxlength="20"
					value="" placeholder="请输入金币备注">
			</div>
		</div>

		<div class="layui-form-item" style="text-align: center;">
			<button class="layui-btn" lay-submit="" lay-filter="addCoin">保存</button>
