...
<body class="childrenBody" style="font-size: 12px; margin: 10px 10px 0;">
	<form class="layui-form layui-form-pane">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" class="layui-input" name="uid" maxlength="20"
					value="${uid}" disabled="disabled">
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label">金币池</label>
			<div class="layui-input-block">
				<input type="text" class="layui-input" name="pool" maxlength="20"
					value="${pool}">
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label">最大回本比例</label>
			<div class="layui-input-block">
				<input type="text" class="layui-input" name="per" maxlength="20"
					value="${per}">
			</div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" class="layui-input" name="perWin" maxlength="20"
					value="${perWin}">
			</div>
		</div>
    ...
    layui.config({
        ...
        form.on("submit(save)",function(data){
            var addCoinLoading = top.layer.msg('数据提交中，请稍候',{icon: 16,time:false,shade:0.8});
            //登陆验证
            $.ajax({
                url : '${ctx}/gameActive/ajax_edit_benzBmw.do',
                type : 'post',
                async: false,
                data : data.field,
